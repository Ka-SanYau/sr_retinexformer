...
if __name__ == '__main__':
    ...
    # input: /home/qc-lab/research/code/low-light/freetest/train_basicsr/datasets/NTIRE_2024/Train_GT
    # output: /home/qc-lab/research/code/low-light/freetest/train_basicsr/datasets/NTIRE_2024/Train_GT_sub_480

    parser.add_argument('--input', type=str, default='/home/qc-lab/research/datasets/SR/div2k/DIV2K_train_HR', help='Input folder')
    parser.add_argument('--output', type=str, default='/home/qc-lab/research/datasets/SR/div2k/DIV2K_train_HR/DF2K_sub', help='Output folder')
